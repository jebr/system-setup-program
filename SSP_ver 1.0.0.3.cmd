...
::zwart/geel
color 0e
title System Setup Program v1.0.0.2
...
echo.
::Disable Windows 10
taskkill /f /im GWX.exe /t >nul
regedit /add HKLM\SOFTWARE\Policies\Microsoft\Windows\Gwx /v DisableGwx /t REG_DWORD /d 1 /f >nul
WUSA /UNINSTALL /KB:3035583 /norestart /quiet >nul
del C:\Windows\System32\GWX /f /q >nul
del C:\Windows\SysWOW64\GWX /f /q >nul
color 0A
cls
echo.
